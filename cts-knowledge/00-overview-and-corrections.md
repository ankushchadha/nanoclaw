...
1. **CTS laptop** — runs **Gen7 Swimming** (now **v2026.0.3**, upgraded 2026-06-20 from V2024.0.1), connected to the Gen7 timer (Ethernet, link-local APIPA). This is where the meet/session and event sequence are built on the timer.
...
- The user's stack is now **Gen7 Swimming v2026.0.3 + DisplayLink v4.7.0** (upgraded 2026-06-20 from V2024.0.1), which clears **both** the names floor and the v2026 Team-Scores/Complete-Event-Results pairing.
...
**Version verdict for this stack (Gen7 Swimming v2026.0.3 + DL+ v4.7.0), UPDATED 2026-06-20 after the upgrade:**
- **Names: WORKING** (confirmed live on the board). Meets the Gen7 v2023+ / DL+ v4.6.0+ floor.
- **Team Scores + Complete Event Results (live auto-feed): NOW SUPPORTED — the Gen7 upgrade was DONE 2026-06-20. [HIGH, F1034 p.81]** The floor is **BOTH Gen7 Swimming v2026 AND DL+ v4.7.0** (F1034 p.81: *"Starting with Gen7 Swimming v2026 and DL+ v4.7.0, support for Team Scores and Complete Event Results was added."*). The rig was upgraded **V2024.0.1 → v2026.0.3** (plus a firmware update) on 2026-06-20, so with DL+ v4.7.0 it now meets **both** floors. **Verify the data renders on the LED BOARD** (per F1034 p.85 it does NOT render in the Gen7 operator screen). Post-upgrade the operator tested the system + scoreboard and it worked. See `07`. (The CTS web product page lists only "DisplayLink+ v4.7.0 required" and omits the Gen7 floor — incomplete vs the manual.)
