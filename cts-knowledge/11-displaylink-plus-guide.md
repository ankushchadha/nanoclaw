...
## ⚠️ VERSION-FLOOR CONFLICT to resolve (affects an upgrade decision)

The current CTS web docs state **only DL+ v4.7.0** is required for "integrated start lists, team scores, and event results" — they name **no Gen7-Swimming version floor**. [HIGH — coloradotime.com/products/gen7-swim-timing-serial] This **conflicts** with this KB's earlier verdict (in `00`/`07`) that live Team Scores / Complete Event Results require **Gen7 Swimming v2026** (which this rig lacks). The Gen7-v2026 requirement could NOT be re-confirmed from any current CTS web page; the research that produced it cited F1034/a support page. **Until a primary source (F1034 or CTS Support) confirms a Gen7-side floor, treat "Gen7 v2026 is required" as UNVERIFIED.** Practical implication: live Team Scores/Results on this rig may need only **DL+ v4.7.0 (already met) + a Hy-Tek Meet Manager license**, NOT a Gen7 upgrade. **Verify with CTS before buying a Gen7 upgrade.** (A WebFetch summary also asserted "Gen7 v2026.0.3" — that string is NOT in the source and was discarded.)
...
- **Version gating:** the Gen7 Swim Timing page states "Integrated start lists, team scores, and event results (**DisplayLink+ v4.7.0 required**)." Only DL+ v4.7.0 is named — see the VERSION-FLOOR CONFLICT note at the top. [HIGH — coloradotime.com/products/gen7-swim-timing-serial]
